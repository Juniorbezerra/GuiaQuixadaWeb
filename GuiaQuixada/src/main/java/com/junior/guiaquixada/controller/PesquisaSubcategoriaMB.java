...
@ManagedBean
@ViewScoped
public class PesquisaSubcategoriaMB implements Serializable{
    
    private List<Subcategoria> subcategorias;
    
    private SubcategoriaFilter subcategoriaFilter;

    public PesquisaSubcategoriaMB() {
    ...
    public int getTamanhoLista(){
        return SubcategoriaDao.getInstance().getListaEntidade(Subcategoria.class).size();
    }
