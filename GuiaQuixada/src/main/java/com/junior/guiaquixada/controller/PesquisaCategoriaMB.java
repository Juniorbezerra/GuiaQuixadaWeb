...
@ManagedBean
@ViewScoped
public class PesquisaCategoriaMB implements Serializable{

    private List<Categoria> categorias;
   
    private CategoriaFilter categoriaFilter;

    public PesquisaCategoriaMB() {
    ...
    public int getTamanhoLista() {
        return CategoriaDao.getInstance().getListaEntidade(Categoria.class).size();
    }
